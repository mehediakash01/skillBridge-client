...
import { LayoutDashboard, CalendarDays, UserCircle, Clock, LogOut } from "lucide-react"
...
const navItems = [
  ...
  { label: "My Profile", href: "/tutor/profile", icon: UserCircle },
    ...
    <div className="flex min-h-screen bg-muted/40">
      <aside className="w-64 bg-white border-r flex flex-col fixed h-full">
        <div className="p-6">
          ...
          <p className="text-xs text-muted-foreground mt-0.5">Tutor Dashboard</p>
        </div>
        ...
        <div className="p-4 space-y-3">
          <div className="flex items-center gap-3 px-2">
            ...
            <div className="overflow-hidden">
              <p className="text-sm font-medium truncate">{user?.name ?? "Tutor"}</p>
