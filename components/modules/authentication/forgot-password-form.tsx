...
import { ArrowRight, GraduationCap, Mail, CheckCircle2, ArrowLeft } from "lucide-react";
        ...
        <div className="relative space-y-6">
          ...
          >
            {[
              ...
              { icon: "📧", text: "Sent directly to your inbox" },
              { icon: "⚡", text: "Takes less than a minute" },
            ].map((item, i) => (
              <motion.div
                key={item.text}
          ...
          <AnimatePresence mode="wait">
            {!emailSent ? (
              ...
              >
                ...
                <p className="font-semibold text-foreground mb-6">{sentToEmail}</p>
